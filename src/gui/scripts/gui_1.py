...
class GeneratorPage(QWidget):
    ...
    def init_ui(self):
        ...
        self.button_1.setFixedSize(400,80)

        self.button_2 = QPushButton("Drilling")
        self.button_2.setFixedSize(400,80)
...
class DrillingExecutionPage(QWidget):
    ...
    def init_ui(self):
        ...
        # self.button_stop.setIcon(QIcon('/home/apurv/Downloads/stop.png'))
        ...
        layout_2.setAlignment(self.button_fault_generator, Qt.AlignCenter)
...
class WeldingExecutionPage(QWidget):
    ...
    def init_ui(self):
        ...
        # self.button_welding_stop.setIcon(QIcon('/home/apurv/Downloads/stop.png'))
        ...
        # layout_1.setAlignment(self.button_welding_back, Qt.AlignLeft)
        # layout_1.addWidget(self.button_welding_kill)
        # layout_1.setAlignment(self.button_welding_kill, Qt.AlignRight)
