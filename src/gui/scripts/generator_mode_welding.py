...
if __name__ == "__main__":
    ...
    subprocess.Popen(['roslaunch', 'panda_gazebo', 'start_workscene_welding.launch', 'gazebo_gui:=false'])    ###True or False
    # rospy.logwarn('will checking model start')
    time.sleep(1)
    ...
    # Put the robot in the world  ###True or False
    subprocess.Popen(['roslaunch', 'panda_gazebo', 'put_robot_in_world_welding.launch','gazebo_gui:=false', 'rviz:=false', 'load_gripper:=false', 'gripper:=welding'])
