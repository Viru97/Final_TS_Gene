...
def joint_state_callback(joint_state_msg):
    ...
    try:
        trans = tfBuffer.lookup_transform('world', 'panda_drill_tcp', ros.Time(0))
...
if __name__ == '__main__':
    ...
    distance1_pub = ros.Publisher('/distance_between_end_effector_and_hand1', Float32, queue_size=100)
    distance2_pub = ros.Publisher('/distance_between_end_effector_and_hand2', Float32, queue_size=100)
    safety_violation_pub = ros.Publisher('/safety_violation', Int32, queue_size=100)
