...
def randomize_hole_position():
    ...
    hole_1_x,hole_1_y,hole_1_z = uniform(-length/3+0.01, length/3-0.01), uniform(-width/3+0.01, width/3-0.01),uniform(0.005008,0.005009)
    hole_2_x,hole_2_y,hole_2_z = uniform(-length/3+0.01, length/3-0.01), uniform(-width/3+0.01, width/3-0.01),uniform(0.005008,0.005009)    
    hole_3_x,hole_3_y,hole_3_z = uniform(-length/3+0.01, length/3-0.01), uniform(-width/3+0.01, width/3-0.01),uniform(0.005008,0.005009)
